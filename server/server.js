...
// ==================== PLANS ROUTER – DYNAMIC IMPORT (WORKS ON RENDER) ====================
import("./routes/planRoutes.js")
  .then((module) => {
    app.use("/api/plans", module.default);
    console.log(
      "Plans router loaded successfully – Admin dashboard will work!"
    );
  })
  .catch((err) => {
    console.error("CRITICAL: Failed to load planRoutes.js →", err);
  });
